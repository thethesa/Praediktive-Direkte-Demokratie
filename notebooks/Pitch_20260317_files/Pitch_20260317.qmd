...
- Entwickelter Zustimmungswert erläutern
...
Aus den Daten geht hervor, dass die Initiativen über lange Zeiträume komplett angenommen wurden. Mit Quervergleichen in den Daten konnte jedoch festgestellt werden, dass in den Jahren zwischen 1950 und 1970 keine Empfehlungen abgegeben wurden oder in den Daten zumindest nicht vorliegen. Dies ist der Grund, warum wir unsere Analyse auf den Zeitraum ab 1970 bis 2025 beschränken.
...
## Diskussion Zustimmungswert
Option A
ZF = Anteil_Zustimmung x Anteil_Mobilisierung
 
Das würden die beiden Anteile gleichwertig betrachten und mit einander multiplizieren. 
10% Mob, 90% Zust = 0.09
 
Das würde aber die Mobilisierungsrate gleichgewichten wie die Zustimmung, was ich aus demokratietheoretischer Sicht nicht ganz so optimal finde. Was sind zum Beispiel die Gründe weshalb Leute nicht wählen geht? Desinteresse, die Überzeugung dass das Anliegen auch ohne ihr zu tun durchkommt. Deshalb bevorzuge ich die Option B: 
 
Option B
ZF = Anteil_Zustimmung  × Anteil_Mobilisierung^αs
 
Wobei Alpha ein Faktor wäre den wir auserkoren würden. Je tiefer Alpha, desto mehr Gewicht geben wir dem Wert Zustimmungswert (z.B. 70% der Personen sind für die Vorlage wie der Bundesrat oder Parlament).  Bei α = 0.5 →  eine Verdopplung der Beteiligung verbessert den Index nur um Faktor ~1.4, nicht um Faktor 2. Claude meint hier: Das reflektiert, dass Mobilisierung ein Qualitätsmerkmal, nicht der Kerngehalt der demokratischen Aussage ist.
![](plots/entscheid_mobilisierung.png)

Wir ziehen die leeren Abgaben von der Gesamtmobilisierung ab, weil diese keine konkrete Aussage zur Zustimmung aussagen.